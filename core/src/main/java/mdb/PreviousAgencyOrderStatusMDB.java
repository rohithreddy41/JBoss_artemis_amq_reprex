...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "PreviousAgencyOrderStatusMDB"),
        @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "AgentOrderStateChange"),
        @ActivationConfigProperty(propertyName = "maxSession", propertyValue = "10")
})
public class PreviousAgencyOrderStatusMDB implements MessageListener {
